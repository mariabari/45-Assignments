...
let originalMagicianNames: string[] = ["David Copperfield", "Harry Houdini", "Penn Jillette", "Teller"];

let originalMagiciansCopy: string[] = [...originalMagicianNames]; // Create a copy of the original array
